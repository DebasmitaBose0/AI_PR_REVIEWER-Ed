...
import { Github, BookOpen, Settings, Moon, Sun, LogOut, Star, Crown, Activity } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4 px-2 py-6">
          <div className="flex items-center gap-4 px-3 py-4 rounded-lg bg-sidebar-accent/50 hover:bg-sidebar-accent/70 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-medium text-sidebar-foreground/90 truncate">@{userName}</p>
            </div>
          </div>
        </div>
      </SidebarHeader>
